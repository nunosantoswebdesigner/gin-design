...
export const CollapsibleDemo = () => {
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-full max-w-sm space-y-2">
      ...
      <div className="rounded-md border px-4 py-3 font-mono text-sm">@radix-ui/react-collapsible</div>
      <CollapsibleContent className="space-y-2">
        <div className="rounded-md border px-4 py-3 font-mono text-sm">@radix-ui/react-dialog</div>
        <div className="rounded-md border px-4 py-3 font-mono text-sm">@radix-ui/react-dropdown-menu</div>
      </CollapsibleContent>
    </Collapsible>
  );
};
