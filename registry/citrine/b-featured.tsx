...
const StatCards = ({ stats }: { stats: FeaturedStat[] }) => (
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    {stats.map((stat, i) => (
      <Card
        key={i}
        className="rounded-none border-0 border-t-2 border-t-yellow-300 bg-transparent shadow-none"
      >
...
const ChartSection = ({
  ...
  return (
    <Card className="rounded-none border-0 border-t-2 border-t-yellow-300 bg-transparent shadow-none">
      <CardHeader>
