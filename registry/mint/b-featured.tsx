...
const StatCards = ({ stats }: { stats: FeaturedStat[] }) => (
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    {stats.map((stat, i) => (
      <Card
        key={i}
        className="rounded-3xl border-white/40 bg-linear-to-br from-white/50 to-primary/10 shadow-xl shadow-primary/20 backdrop-blur-xl dark:border-white/10 dark:from-white/5 dark:to-primary/10"
      >
...
const ChartSection = ({
  ...
  return (
    <Card className="rounded-3xl border-white/40 bg-linear-to-br from-white/50 to-primary/10 shadow-xl shadow-primary/20 backdrop-blur-xl dark:border-white/10 dark:from-white/5 dark:to-primary/10">
      <CardHeader>
