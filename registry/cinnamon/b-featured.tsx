...
const StatCards = ({ stats }: { stats: FeaturedStat[] }) => (
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    {stats.map((stat, i) => (
      <Card
        key={i}
        className="rounded-2xl border-2 border-orange-800 bg-orange-50 shadow-[0_6px_0_0_rgb(124,45,18)] dark:border-orange-600 dark:bg-orange-950/40 dark:shadow-[0_6px_0_0_rgb(67,20,7)]"
      >
...
const ChartSection = ({
  ...
  return (
    <Card className="rounded-2xl border-2 border-orange-800 bg-orange-50 shadow-[0_6px_0_0_rgb(124,45,18)] dark:border-orange-600 dark:bg-orange-950/40 dark:shadow-[0_6px_0_0_rgb(67,20,7)]">
      <CardHeader>
