...
const StatCards = ({ stats }: { stats: FeaturedStat[] }) => (
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    {stats.map((stat, i) => (
      <Card
        key={i}
        className="rounded-none border-2 border-foreground shadow-[6px_6px_0_0_var(--foreground)]"
      >
...
const ChartSection = ({
  ...
  return (
    <Card className="rounded-none border-2 border-foreground shadow-[6px_6px_0_0_var(--foreground)]">
      <CardHeader>
